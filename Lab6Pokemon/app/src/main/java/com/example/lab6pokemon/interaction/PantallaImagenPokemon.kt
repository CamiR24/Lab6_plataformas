...
class PantallaImagenPokemon : ComponentActivity() {
        ...
        setContent {
            Lab6PokemonTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    CenterAlignedTopAppBarImagenes(navController = rememberNavController(), innerPadding = PaddingValues())
                }
            }
        }
    }
...
@Composable
fun CenterAlignedTopAppBarImagenes(navController: NavHostController, innerPadding: PaddingValues) {
    val scrollBehavior = TopAppBarDefaults.pinnedScrollBehavior(rememberTopAppBarState())
    val pokemon = remember { Pokemon(name = "", url = "") }
    ...
    Scaffold(
        ...
        ImagenesPokemonGrid(pokemon = pokemon, innerPadding)
    }
}

@Composable
fun ImagenesPokemonGrid(pokemon: Pokemon, innerPadding: PaddingValues) {
